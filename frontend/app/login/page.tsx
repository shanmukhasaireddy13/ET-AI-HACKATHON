  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-[300px] h-[300px] rounded-full bg-pink-600/10 blur-[120px]" />
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="p-8 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl">
          ...
          <p className="text-neutral-400 text-center text-sm mb-8">Sign in to your account to continue</p>
